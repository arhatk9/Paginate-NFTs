...
Developed an app based on NEXT.JS to list NFT's of any user using their Wallet ID in Solana Network, during the Solana CampusConnect Event in IIT Delhi.
